...
const prevPagina = document.querySelector(".prev-page");
const totalPaginas = document.getElementById("total-paginas");
const primerPagina = document.querySelector(".first-page");
      ...
      <div class="contenedor-cards">
        <div class="card">
            ...
            <div class="card-content">
                ...
                <p>Genero:${personaje.gender === "Female" ? "Mujer" : "" || personaje.gender === "Male" ? "Hombre" : "" || personaje.gender === "unknown" ? "Desconocido" : "" || personaje.gender === "Genderless" ? "Sin género" : ""}</p>
                <p>Especies:${personaje.species}</p>
                <p>Estado:${personaje.status === "Alive" ? "Vivo" : "" || personaje.status === "Dead" ? "Muerto" : "" || personaje.status === "unknown" ? "Desconocido" : ""}</p>
                <p>Origen:${personaje.origin.name}</p>
                <p>Locacion:${personaje.location.name}</p>   
            </div>
            <div class="ver-mas">
            <a href="https://rickandmortyapi.com/api/character/${personaje.id}" target="_blank"> 
            Ver Más...
            </a>
            </div>
        </div>
